...
export const investorGuide: GuideContent = {
  ...
  blocks: [
    ...
    {
      kind: "collections",
      heading: "What's launched, and what it costs",
      intro: "Three collections span the price spectrum, from resort-style apartments to ultra-prime signature mansions.",
      items: COLLECTIONS,
    },
    {
      kind: "pullquote",
      text: "You are not buying a finished address. You are buying a position on an island the city is still building around it.",
    },
    {
      kind: "prose",
    ...
    {
      kind: "prose",
      heading: "Palm Jebel Ali vs Palm Jumeirah",
      body: [
    ...
    },
    {
      ...
      columns: 2,
      items: [
        { title: "Construction & timeline risk", body: "This is off-plan on a decade-long build. Phasing can move, and your capital is committed years before handover." },
        { title: "Liquidity", body: "The resale (secondary) market is thin while the island is under construction; exiting early may mean a slower sale." },
        { title: "Scale takes time", body: "An island twice the size of Palm Jumeirah matures over many years — the full amenity picture is a long-term horizon." },
        { title: "Entry price discipline", body: "Off-plan returns hinge on the price you enter at. Overpaying at launch erodes the very advantage you're buying." },
      ],
    },
    {
      kind: "prose",
  ...
  faqs: [
    ...
    {
      question: "How does it compare to buying on Palm Jumeirah?",
      answer:
  ...
  cta: {
    heading: "Talk it through with someone who tracks the releases",
    body: "Every buyer's timeline is different. Tell us yours and we'll give you a straight read on whether — and where — Palm Jebel Ali fits.",
