...
export const hotels: GuideContent = {
  meta: {
    ...
    keywords: [
      ...
      "Palm Jebel Ali beach clubs",
      "Palm Jebel Ali hospitality",
      "resort island Dubai",
  ...
  hero: {
    ...
    titleItalic: "a resort island by design",
    subtitle:
  ...
  atAGlance: [
    ...
    { k: "Positioning", v: "Outer fronds & island edges" },
    { k: "Mix", v: "Five-stars, eco-retreats, boutique, serviced" },
    { k: "For residents", v: "Dining, spas & beach clubs on the doorstep" },
    { k: "Delivery", v: "Phased, with later island phases" },
  ...
  blocks: [
    ...
    {
      kind: "prose",
      heading: "The scale of the hospitality",
      body: [
    ...
    {
      kind: "pullquote",
      text: "Eighty-plus hotels is not an amenity footnote. It is the difference between a neighbourhood by the sea and a resort island you happen to live on.",
    },
    {
      kind: "cards",
      heading: "The kinds of stays planned",
      intro:
      ...
      items: [
        {
          title: "Beachfront five-stars",
          body: "Full-service resorts on the outer fronds — the flagship stays that anchor the island's hospitality and open their beaches, restaurants and spas to the wider community.",
        },
        {
          title: "Eco-retreats",
          body: "Lower-density, nature-led properties for guests who want the coastline and the calm — a quieter counterpoint to the marquee resorts.",
        },
        {
          title: "Serviced apartments",
          body: "Hotel-serviced residences built for longer stays — useful for visiting family, relocating buyers testing the island, or owners who want hotel amenities without a permanent second home.",
        },
        {
          title: "Boutique stays",
          body: "Smaller, design-led properties that give the island texture beyond the big flags — the independent restaurants, bars and rooms that make a destination feel lived-in.",
        },
      ],
    },
    {
      kind: "prose",
      heading: "What the hotel mix means if you live here",
      body: [
    ...
    {
      kind: "cards",
      heading: "What the hotels bring to the doorstep",
      columns: 3,
      items: [
        {
          title: "Dining",
          body: "Hotel and independent restaurants within the island — from casual beachfront to destination fine dining, without leaving home.",
        },
        {
          title: "Wellness & spas",
          body: "Resort spas and wellness facilities on your doorstep, open to residents as well as guests.",
        },
        {
          title: "Beach clubs & leisure",
          body: "Poolside days, beach clubs and waterfront leisure as part of everyday life rather than a day trip.",
        },
      ],
    },
    {
    ...
    {
      kind: "prose",
      heading: "How and when the hotels arrive",
      body: [
  ...
  faqs: [
    {
      question: "How many hotels are planned at Palm Jebel Ali?",
      answer:
    ...
    {
      question: "Can residents use the hotel amenities?",
      answer:
    ...
    {
      question: "Are the hotels open yet?",
      answer:
    ...
    {
      question: "Why do the hotels matter for investment?",
      answer:
    ...
    {
      question: "What kinds of hotels will there be?",
      answer:
  ...
  related: [
    { href: "/communities/palm-jebel-ali", label: "Palm Jebel Ali community", kicker: "Community" },
  ...
  cta: {
    heading: "Picture the island as it's meant to live",
    body: "From beach clubs to eco-retreats, the hospitality layer is what makes Palm Jebel Ali a resort island. Ask us how the phasing lines up with the homes launching now.",
