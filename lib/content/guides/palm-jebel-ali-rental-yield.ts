...
export const rentalYield: GuideContent = {
  meta: {
    ...
    keywords: [
      ...
      "Palm Jebel Ali ROI",
      "Palm Jebel Ali short-term rental",
      "Palm Jebel Ali investment income",
  ...
  hero: {
    ...
    title: "Palm Jebel Ali rental yield,",
  ...
  atAGlance: [
    { k: "Rental market", v: "Not yet live — post-handover" },
    { k: "Current yield", v: "No honest figure exists yet" },
    { k: "Near-term play", v: "Capital appreciation, off-plan" },
    { k: "Income horizon", v: "After phased handover, 2027+" },
    { k: "Likely demand", v: "Beachfront scarcity, hotels, location" },
    { k: "Directional proxy", v: "Palm Jumeirah (completed, qualitative)" },
    { k: "Let types", v: "Short-let and long-let, once complete" },
  ...
  blocks: [
    ...
    {
      kind: "prose",
      heading: "Why there's no yield to report yet",
      body: [
    ...
    {
      kind: "cards",
      heading: "What could drive future rental demand here",
      intro:
      ...
      items: [
        {
          ...
          body: "Freehold beachfront on a man-made island is a fixed, finite supply. Frond-front homes with private beach access are exactly the kind of stock that stays in demand from tenants who want what can't be built more of.",
        },
        {
          title: "Hotels & resort amenities",
          body: "The master plan carries 80+ hotels alongside marinas, retail and beach clubs. A live hospitality layer tends to lift both short-let appeal and the everyday desirability that underpins long leases.",
        },
        {
          title: "Location & the southern corridor",
          body: "The island sits beside Al Maktoum International (DWC) and Expo City, with direct access to Sheikh Zayed Road. As that corridor fills in, a tenant base — professionals, relocating families — grows around it.",
        },
        {
          title: "The address itself",
          body: "A recognised flagship island carries a brand premium. Tenants pay for a name and a lifestyle, not just square footage — and a second Palm is designed to be a name.",
        },
      ],
    },
    {
      kind: "pullquote",
      text: "There is no yield to quote yet — only the forces that will one day set one. Anyone printing a number today is guessing, or selling.",
    },
    {
      kind: "prose",
      heading: "Palm Jumeirah as a directional benchmark",
      body: [
    ...
    {
      kind: "prose",
      heading: "Appreciation now, rental income later",
      body: [
    ...
    {
      kind: "prose",
      heading: "Short-let vs long-let, once it's complete",
      body: [
    ...
    {
      kind: "cards",
      heading: "Honest caveats before you bank on income",
      columns: 2,
      items: [
        {
          title: "No data means no promises",
          body: "Every rental figure for Palm Jebel Ali today is speculative. Don't underwrite a purchase on a yield nobody can substantiate.",
        },
        {
          title: "Income starts after handover",
          body: "You can't let a home that hasn't handed over. First phases begin 2027; your income clock starts then, not now.",
        },
        {
          title: "Supply at handover is unknown",
          body: "When many homes complete at once, near-term rents can soften before the market settles. The pace of demand versus supply matters.",
        },
        {
          title: "Rules can change",
          body: "Short-let regulation, service charges and market conditions years out are all moving parts. Model income conservatively, if at all.",
        },
      ],
    },
    {
  ...
  faqs: [
    {
      question: "What is the rental yield on Palm Jebel Ali?",
      answer:
    ...
    {
      question: "Can I rent out a Palm Jebel Ali property now?",
      answer:
    ...
    {
      question: "Should I buy for rental income or capital appreciation?",
      answer:
    ...
    {
      question: "Does Palm Jumeirah tell me what Palm Jebel Ali will yield?",
      answer:
    ...
    {
      question: "Will short-term or long-term letting earn more here?",
      answer:
    ...
    {
      question: "When will there be real yield data for Palm Jebel Ali?",
      answer:
  ...
  related: [
    { href: "/pulse/guides/palm-jebel-ali-investor-guide", label: "The full investment case", kicker: "Guide" },
    { href: "/pulse/guides/palm-jebel-ali-handover-timeline", label: "Handover timeline explained", kicker: "Guide" },
    { href: "/rent-property-in/palm-jebel-ali", label: "Rentals on Palm Jebel Ali", kicker: "Rent" },
  ],

  cta: {
    heading: "Want a straight read on income, not a sales number?",
    body: "We'll tell you honestly where appreciation ends and rental income begins for your timeline — and what to watch as the first phases approach handover.",
