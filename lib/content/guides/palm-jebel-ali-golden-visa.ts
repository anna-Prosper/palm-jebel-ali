...
export const goldenVisa: GuideContent = {
  ...
  hero: {
    eyebrow: "Golden Visa Guide",
    title: "A Palm Jebel Ali address,",
  ...
  atAGlance: [
    { k: "Visa term", v: "10 years, renewable" },
    { k: "Property route", v: `${FACTS.goldenVisaThresholdAed}+ in real estate` },
    { k: "PJA entry", v: "From AED 2.5M (apartments)" },
    { k: "Every collection", v: "Clears the threshold" },
    { k: "Off-plan", v: "Generally eligible on value" },
    { k: "Family", v: "Spouse & children typically included" },
    { k: "Ownership", v: "Freehold, all nationalities" },
    { k: "Status", v: "Confirm current rules on application" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "collections",
      heading: "How every collection clears the line",
      intro: `Whichever collection you choose, the purchase price sits above the ${FACTS.goldenVisaThresholdAed} property threshold — the entry point clears it, and everything above only clears it more comfortably. Eligibility is still assessed on your individual application.`,
      items: COLLECTIONS,
    },
    {
      kind: "prose",
    ...
    {
      kind: "pullquote",
      text: "On Palm Jebel Ali the threshold isn't a hurdle to clear — the cheapest home on the island already sits above it.",
    },
    {
      kind: "prose",
      heading: "How off-plan purchases qualify",
      body: [
    ...
    {
      kind: "prose",
      heading: "Who the visa can cover",
      body: [
    ...
    },
    {
      ...
      intro: "Roughly, the path from purchase to visa runs like this. Timelines and exact requirements are set by the authorities and change periodically — treat this as the shape of the process, not a fixed checklist.",
      items: [
        {
          title: "1. Reserve your Palm Jebel Ali home",
          body: "Choose a collection and reserve. Because every home on the island is priced above the AED 2 million threshold, the purchase itself puts you in qualifying territory on value.",
        },
        {
          title: "2. Register the purchase with the DLD",
          body: "Your off-plan purchase is registered with the Dubai Land Department, typically evidenced by an Oqood certificate. This registered value is what the property route is assessed against.",
        },
        {
          title: "3. Prepare your documentation",
          body: "The application draws on your title/registration proof, passport, photographs and standard supporting papers. Requirements are updated from time to time, so confirm the current list before compiling.",
        },
        {
          title: "4. Apply for the Golden Visa",
          body: "The application is submitted to the relevant UAE authority. Eligibility is assessed on your individual case — value, registration and the current rules in force at the time you apply.",
        },
        {
          title: "5. Add your family and complete medical/Emirates ID",
          body: "Once approved, family members can generally be sponsored onto the visa, alongside the standard medical and Emirates ID steps that finalise residency.",
        },
      ],
    },
    {
      kind: "cards",
      heading: "Why buyers value it",
      columns: 2,
      items: [
        { title: "A decade of stability", body: "Ten renewable years of residency that don't depend on an employer or a job contract — status that stays yours." },
        { title: "The whole family", body: "The visa can typically extend to a spouse and children, so one purchase settles the household, not just the buyer." },
        { title: "Live, work, study", body: "Long-term residence lets you build a genuine base in the UAE — schooling, business, banking — on a stable footing." },
        { title: "One decision, two outcomes", body: "The same commitment secures a beachfront position on the island and anchors your residency. The property is the qualifier." },
      ],
    },
    {
      kind: "prose",
      heading: "A grounded expectation",
      body: [
  ...
  faqs: [
    {
      question: "Does buying on Palm Jebel Ali qualify me for the Golden Visa?",
      answer:
    ...
    {
      question: "How much property do I need to own to qualify?",
      answer:
    ...
    {
      question: "Can an off-plan Palm Jebel Ali purchase count, even before it's built?",
      answer:
    ...
    {
      question: "Does the visa cover my family?",
      answer:
    ...
    {
      question: "Who actually decides if I get the visa?",
      answer:
  ...
  related: [
    ...
    { href: "/communities/palm-jebel-ali", label: "Explore the Palm Jebel Ali community", kicker: "Community" },
  ],

  cta: {
    heading: "Buying for residency? Let's structure it that way",
    body: "If the Golden Visa is part of why Palm Jebel Ali appeals, tell us — we'll walk you through which collection fits, how the off-plan registration works, and how to approach the visa with your circumstances in view.",
