...
export const vsJumeirahBay: GuideContent = {
  meta: {
  ...
  hero: {
    ...
    title: "Palm Jebel Ali vs Jumeirah Bay Island,",
    titleItalic: "scale against scarcity",
    subtitle:
  ...
  atAGlance: [
    { k: "Palm Jebel Ali", v: "Off-plan, launch phase" },
    { k: "Jumeirah Bay", v: "Completed, established" },
    { k: "PJA developer", v: "Nakheel" },
    { k: "JBI developer", v: "Meraas" },
    { k: "PJA scale", v: "16 fronds · ~2× Palm Jumeirah" },
    { k: "JBI scale", v: "Micro-island, seahorse-shaped" },
    { k: "PJA entry", v: "From AED 2.5M" },
    { k: "Signature name", v: "Bulgari (JBI) vs SAOTA (PJA)" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "pullquote",
      text: "Palm Jebel Ali sells you a position on a coastline still being built. Jumeirah Bay sells you a seat at a table that's already full.",
    },
    {
      kind: "prose",
      heading: "Product: a whole island versus a handful of addresses",
      body: [
    ...
    {
      kind: "cards",
      heading: "Two islands, side by side",
      intro:
      ...
      items: [
        {
          title: "Palm Jebel Ali — scale, off-plan",
          body: "Nakheel's 16-frond mega-island, roughly twice the size of Palm Jumeirah, with around 110km of new coastline. Sold off-plan at launch pricing across three collections, from apartments to ultra-prime mansions, on a phased handover.",
          meta: "Breadth · upside · long horizon",
        },
        {
          title: "Jumeirah Bay Island — scarcity, established",
          body: "Meraas's seahorse-shaped micro-island off Jumeirah, completed and occupied. Anchored by the Bulgari Resort & Residences and a marina, with a finite run of ultra-prime villas and apartments. A finished, hard-to-enter address.",
          meta: "Concentration · certainty · finite",
        },
        {
          title: "What Palm Jebel Ali gives you",
          body: "A choice of entry points, launch-phase pricing set before the island's amenities come online, and a genuinely long appreciation runway as fronds fill in and Dubai's southern corridor matures around it.",
          meta: "You buy early into growth",
        },
        {
          title: "What Jumeirah Bay gives you",
          body: "A completed, proven, walk-in address with the Bulgari name attached, established neighbours, and the security of buying something that already exists in a location the market has long since priced.",
          meta: "You buy into a settled address",
        },
      ],
    },
    {
    ...
    {
      kind: "prose",
      heading: "Maturity: finished versus in the making",
      body: [
  ...
  faqs: [
    {
      question: "What's the main difference between Palm Jebel Ali and Jumeirah Bay Island?",
      answer:
    ...
    {
      question: "Which island is more exclusive?",
      answer:
    ...
    {
      question: "How much does it cost to buy on Palm Jebel Ali versus Jumeirah Bay?",
      answer:
    ...
    {
      question: "Is Jumeirah Bay Island completed?",
      answer:
    ...
    {
      question: "What is Jumeirah Bay Island known for?",
      answer:
    ...
    {
      question: "Which island should I buy on?",
      answer:
  ...
  related: [
    { href: "/residences/coral-collection", label: "The Coral Collection mansions", kicker: "Residences" },
  ...
  cta: {
    heading: "Weighing scale against scarcity?",
    body: "Tell us what you're really after — a finite, finished address or a position on Dubai's next flagship island — and we'll give you a straight read on where Palm Jebel Ali fits.",
