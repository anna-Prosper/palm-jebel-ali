...
export const forUkBuyers: GuideContent = {
  meta: {
    slug: "pulse/guides/palm-jebel-ali-for-uk-buyers",
    title: "Palm Jebel Ali for UK Buyers | Buying Off-Plan from Britain",
    description:
      "A UK buyer's guide to Palm Jebel Ali: freehold ownership, the AED/GBP angle, remote buying, Golden Visa and what British investors should weigh.",
    keywords: [
      "Palm Jebel Ali UK buyers",
  ...
  atAGlance: [
    ...
    { k: "Payment plan", v: "80/20, staged" },
    { k: "Golden Visa", v: "Eligible (AED 2M+)" },
    { k: "Buy remotely", v: "Yes — POA / e-signature" },
    { k: "UK tax", v: "Take independent advice" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "prose",
      heading: "Why UK buyers look to Dubai",
      body: [
    ...
    {
      kind: "pullquote",
      text: "You do not need to be in Dubai to buy in Dubai. The paperwork can be done from a kitchen table in Britain — the island is the only part that has to be there.",
    },
    {
      kind: "prose",
    ...
    {
      kind: "steps",
      heading: "The path to reserving, step by step",
      intro: "For a UK-based buyer, the sequence is more orderly than it first looks.",
      items: [
        {
          title: "1. Set your budget in both currencies",
          body: "Decide what you can commit in pounds, then look at it in dirhams — including the booking deposit and the rhythm of the 80/20 instalments. Build in headroom for currency movement across the construction period.",
        },
        {
          title: "2. Choose the collection and unit",
          body: "Palm Central apartments start from AED 2.5M, Beach Collection villas from AED 18.5M, Coral mansions from AED 30M. Shortlist against your budget and how you'll actually use the home.",
        },
        {
          title: "3. Reserve remotely",
          body: "Complete the reservation form and pay the booking deposit through an authorised agent. Most of this happens by e-signature and international transfer from the UK.",
        },
        {
          title: "4. Sign the sales-purchase agreement",
          body: "Review the SPA and payment schedule. A Power of Attorney can cover any step that needs a physical signature in Dubai on your behalf.",
        },
        {
          title: "5. Plan the currency and the instalments",
          body: "Line up a foreign-exchange provider and a plan for each milestone payment, then take independent UK tax advice before you're too far in.",
        },
      ],
    },
    {
      kind: "cards",
      heading: "What British buyers weigh",
      columns: 2,
      items: [
        {
          title: "Freehold, in your name",
          body: "Ownership is registered with the Dubai Land Department — the same title a resident buyer holds, not a lease or a nominee structure.",
        },
        {
          title: "The 80/20 plan",
          body: "20% on booking, 60% across construction milestones, 20% on handover. Your capital goes in gradually, which also spreads your currency exposure.",
        },
        {
          title: "Golden Visa eligibility",
          body: "Every collection clears the AED 2M property threshold for the UAE's 10-year renewable Golden Visa — assessed on your individual application.",
        },
        {
          title: "Take UK tax advice",
          body: "How a Dubai purchase interacts with your UK position depends on your residency and circumstances. Confirm current rules with a qualified adviser — not a brochure.",
        },
      ],
    },
    {
      kind: "prose",
      heading: "The Golden Visa, briefly",
      body: [
    ...
    {
      kind: "prose",
      heading: "A note on UK tax — read this twice",
      body: [
  ...
  faqs: [
    {
      question: "Can a UK citizen buy property in Palm Jebel Ali?",
      answer:
    ...
    {
      question: "Do I have to fly to Dubai to buy?",
      answer:
    ...
    {
      question: "How does the currency work for a UK buyer?",
      answer:
    ...
    {
      question: "What are the UK tax implications?",
      answer:
    ...
    {
      question: "Does buying here get me a Golden Visa?",
      answer:
    ...
    {
      question: "How much do I need to get in?",
      answer:
  ...
  cta: {
    heading: "Buying from the UK? Let's make it straightforward",
    body: "Tell us your budget and timeline and we'll walk you through reserving remotely — from the currency plan to the paperwork — with no pressure and no jargon.",
