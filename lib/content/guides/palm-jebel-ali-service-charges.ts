...
export const serviceCharges: GuideContent = {
  meta: {
    ...
    keywords: [
      ...
      "Palm Jebel Ali maintenance fees",
  ...
  hero: {
    ...
    title: "Palm Jebel Ali service charges,",
  ...
  atAGlance: [
    { k: "What it is", v: "Annual community & building upkeep fee" },
    { k: "How it's charged", v: "Per sqft, per year" },
    { k: "Who oversees it", v: "Dubai's RERA, via the Mollak system" },
    { k: "Covers", v: "Maintenance, security, landscaping, common areas" },
    { k: "PJA rates", v: "Confirmed near handover — not yet published" },
    { k: "Also budget", v: "Cooling / DEWA, insurance, management if renting" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "prose",
      heading: "What a service charge actually is",
      body: [
      ...
      items: [
        {
          ...
          body: "Day-to-day repair and upkeep of shared structures, roads, walkways, lighting and building systems across the community.",
        },
        {
          title: "Security & access",
          body: "Manned security, gatehouses, patrols, CCTV and access control — a meaningful line item on a gated island community.",
        },
        {
          title: "Landscaping & cleaning",
          body: "Irrigation and maintenance of the fronds' greenery, public realm cleaning, waste management and beach upkeep.",
        },
        {
          title: "Amenities & common areas",
          body: "Pools, gyms, clubhouses, promenades and shared leisure spaces — the more resort-grade the offering, the more there is to run.",
        },
        {
          title: "Master-community charge",
          body: "A community-wide contribution to island infrastructure and shared services that sits above any individual building's charge.",
        },
        {
          title: "Reserve fund",
          body: "A ring-fenced sinking fund set aside for major future works — repainting, plant replacement, structural repairs — so owners aren't hit with sudden one-off levies.",
        },
      ],
    },
    {
      kind: "prose",
      heading: "How Dubai sets and governs service charges",
      body: [
    ...
    {
      kind: "pullquote",
      text: "A firm per-sqft figure for a pre-handover island isn't a fact yet — it's a guess. The honest answer is to explain the mechanics now and hold the number until it's confirmed.",
    },
    {
      kind: "cards",
      heading: "The other running costs to budget for",
      intro:
      ...
      items: [
        {
          title: "Cooling (district cooling)",
          body: "Large master communities are often served by district cooling, billed separately from DEWA — sometimes with a fixed capacity charge plus consumption. Worth confirming per building.",
        },
        {
          title: "DEWA — electricity & water",
          body: "Standard utility bills from the Dubai Electricity and Water Authority, plus a housing/municipality fee typically collected through the DEWA account.",
        },
        {
          title: "Home insurance",
          body: "Buildings and contents cover for a high-value beachfront villa is prudent and modest relative to the asset. Lenders usually require it where there's a mortgage.",
        },
        {
          title: "Property management (if you let)",
          body: "If you rent the home out, expect a management or letting fee as a share of rent, covering tenant sourcing, maintenance coordination and inspections.",
        },
      ],
    },
    {
      kind: "prose",
      heading: "What an island community implies for charges",
      body: [
    ...
    {
      kind: "steps",
      heading: "How to get Palm Jebel Ali's confirmed rates",
      intro:
        "Because rates are set closer to handover, here's the sensible path to a firm number when you need one.",
      items: [
        {
          title: "Ask at reservation for the current position",
          body: "At booking, the developer can share whatever indicative guidance exists and confirm what has and hasn't been finalised. We'll always give you the honest status rather than a placeholder figure.",
        },
        {
          title: "Watch for the RERA-approved budget near handover",
          body: "As each phase approaches completion, the community's service-charge budget is prepared and submitted for RERA approval — that approved figure is the one to plan around.",
        },
        {
          title: "Confirm the full running-cost stack before you commit to let",
          body: "Ahead of handover, pin down service charge, cooling arrangement and any master-community fee together, so a rental yield calculation is built on real costs, not estimates.",
        },
      ],
    },
    {
  ...
  faqs: [
    {
      question: "What are the service charges at Palm Jebel Ali?",
      answer:
    ...
    {
      question: "What do service charges pay for?",
      answer:
    ...
    {
      question: "Will service charges on Palm Jebel Ali be high because it's a beachfront island?",
      answer:
    ...
    {
      question: "What other running costs should I budget for beyond the service charge?",
      answer:
    ...
    {
      question: "When will Palm Jebel Ali's service charges be confirmed?",
      answer:
  ...
  related: [
    ...
    { href: "/pulse/guides/palm-jebel-ali-rental-yield", label: "Rental yield explained", kicker: "Guide" },
    { href: "/communities/palm-jebel-ali", label: "Explore the community", kicker: "Community" },
  ],

  cta: {
    heading: "Get a straight read on the full cost of ownership",
    body: "We'll walk you through the running-cost picture as it stands, flag what's still to be confirmed, and make sure your budget is built on facts — not placeholder numbers.",
