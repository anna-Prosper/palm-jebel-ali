...
export const vsPalmJumeirah: GuideContent = {
  ...
  atAGlance: [
    { k: "Palm Jumeirah", v: "Completed, proven, liquid" },
    { k: "Palm Jebel Ali", v: "Off-plan, launch phase" },
    { k: "Relative scale", v: "PJA ~2× Palm Jumeirah" },
    { k: "PJA fronds", v: "16 fronds" },
    { k: "PJA coastline", v: "110 km of new shoreline" },
    { k: "PJ coastline", v: "~56 km" },
    { k: "PJA entry", v: "From AED 2.5M" },
    { k: "Best for", v: "Income now vs upside later" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "pullquote",
      text: "Palm Jumeirah sells you a proven address at today's price. Palm Jebel Ali sells you a position on an island the city is still building around it.",
    },
    {
      kind: "cards",
      heading: "Maturity versus upside",
      intro:
        "The single most important difference isn't size — it's where each island sits on its own timeline.",
      columns: 2,
      items: [
        {
          title: "Palm Jumeirah — the proven asset",
          body: "Completed, occupied and internationally recognised. Homes, hotels, beach clubs and retail all exist and operate today. You can view the exact villa or apartment, move in, and know precisely what you own from day one.",
          meta: "Certainty, income, liquidity",
        },
        {
          title: "Palm Jebel Ali — the launch-phase play",
          body: "Sold off-plan at launch pricing, before hotels, marinas and beach clubs are operational. You commit against a master plan and a phased handover, betting on the island — and Dubai's southern corridor — maturing over the years ahead.",
          meta: "Scarcity, timing, appreciation",
        },
        {
          title: "What Palm Jumeirah teaches",
          body: "Its own history is the reference case: the buyers who committed earliest, before the island was proven, captured the largest gains as it filled in. That is the pattern Palm Jebel Ali buyers are trying to sit in front of today.",
          meta: "History rhymes, it doesn't repeat",
        },
        {
          title: "The honest caveat",
          body: "A larger island takes longer to mature, and off-plan carries construction and timeline risk that a finished Palm Jumeirah home simply does not. Upside and risk are the same coin seen from two sides.",
          meta: "Longer horizon, real risk",
        },
      ],
    },
    {
  ...
  faqs: [
    {
      question: "Which is a better investment, Palm Jebel Ali or Palm Jumeirah?",
      answer:
    ...
    {
      question: "How much bigger is Palm Jebel Ali than Palm Jumeirah?",
      answer:
    ...
    {
      question: "Why is Palm Jebel Ali cheaper to enter than Palm Jumeirah?",
      answer:
    ...
    {
      question: "Is Palm Jebel Ali likely to appreciate like Palm Jumeirah did?",
      answer:
    ...
    {
      question: "Do both islands qualify for the Golden Visa?",
      answer:
  ...
  related: [
    ...
    { href: "/pulse/guides/palm-jebel-ali-villas", label: "Inside the villa collections", kicker: "Guide" },
    { href: "/off-plan-in/palm-jebel-ali", label: "See current off-plan launches", kicker: "Buy" },
  ],

  cta: {
    heading: "Still torn between the two Palms?",
    body: "Tell us your timeline and what you want the property to do — income, appreciation, or a home to move into — and we'll give you a straight read on which island fits.",
