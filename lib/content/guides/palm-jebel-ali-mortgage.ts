...
export const mortgage: GuideContent = {
  meta: {
    ...
    keywords: [
      ...
      "Palm Jebel Ali payment plan financing",
  ...
  hero: {
    ...
    title: "Financing Palm Jebel Ali,",
  ...
  atAGlance: [
    ...
    { k: "During build", v: "60% across milestones" },
    { k: "On handover", v: "20% — often mortgaged" },
    { k: "DLD fee", v: "4% of purchase price" },
    { k: "Mortgage timing", v: "Usually arranged near handover" },
    { k: "Who lends", v: "UAE banks finance off-plan" },
    { k: "Terms", v: "Vary by bank & buyer profile" },
  ],
  ...
  blocks: [
    ...
    {
      kind: "prose",
      heading: "Cash or mortgage on off-plan — the honest framing",
      body: [
    ...
    {
      kind: "steps",
      heading: "The financing journey, start to finish",
      intro: "How funding typically unfolds across the life of an off-plan purchase here.",
      items: [
        {
          title: "1 — Reserve and pay the deposit",
          body: "You book your unit and pay the 20% deposit, plus the 4% DLD registration fee. This stage is almost always funded from your own capital — banks generally do not lend against an unbuilt property at reservation.",
        },
        {
          title: "2 — Fund the construction milestones",
          body: "Across the build, you pay the 60% middle tranche in scheduled instalments tied to construction progress. This is the developer's interest-free plan doing the work of a loan — no bank, no interest, just staged payments to Nakheel.",
        },
        {
          title: "3 — Plan your mortgage before handover",
          body: "As handover approaches and the property nears completion, this is when a mortgage becomes practical. Speak to a bank or broker several months ahead so approval is ready when the final payment falls due — not after.",
        },
        {
          title: "4 — Complete with the handover payment",
          body: "The final 20% is settled at handover. Many buyers cover this from a mortgage drawn on the now-completed home; others clear it in cash. Mortgage registration with the DLD happens at this stage if you borrow.",
        },
      ],
    },
    {
      kind: "pullquote",
      text: "The developer's 80/20 plan is itself financing — interest-free, staged, and often enough to carry you most of the way to handover before a bank is ever involved.",
    },
    {
      kind: "prose",
      heading: "Resident vs non-resident financing",
      body: [
    ...
    {
      kind: "cards",
      heading: "Leveraging vs paying cash",
      intro: "Neither is 'correct' — it depends on your capital, your currency exposure and what else that money could be doing.",
      columns: 2,
      items: [
        {
          title: "The case for a mortgage",
          body: "Leverage frees your capital for other uses and can amplify returns if the asset appreciates. It also lets you hold a larger or better-positioned home than an all-cash budget would allow, and spreads the cost over time.",
        },
        {
          title: "The cost of borrowing",
          body: "A mortgage means interest, arrangement and valuation fees, and monthly obligations regardless of how construction or the market moves. On off-plan, you also carry the risk before the asset is income-producing.",
        },
        {
          title: "The case for cash",
          body: "Paying cash removes interest cost, financing conditions and lender timelines entirely. Combined with the interest-free 80/20 plan, many buyers here find they can complete comfortably without a bank at all.",
        },
        {
          title: "The middle path",
          body: "A common approach: self-fund the deposit and milestones from cash, then take a mortgage only for the final handover tranche — keeping leverage low while still preserving some liquidity.",
        },
      ],
    },
    {
    ...
    {
      kind: "prose",
      heading: "Who to speak to, and when",
      body: [
  ...
  faqs: [
    {
      question: "Can I get a mortgage on an off-plan Palm Jebel Ali home?",
      answer:
    ...
    {
      question: "How does the 80/20 payment plan affect financing?",
      answer:
    ...
    {
      question: "Do non-residents have to pay more to finance a purchase?",
      answer:
    ...
    {
      question: "Is it better to pay cash or take a mortgage?",
      answer:
    ...
    {
      question: "What fees should I budget for beyond the price?",
      answer:
    ...
    {
      question: "When should I start arranging a mortgage?",
      answer:
  ...
  cta: {
    heading: "Work out the funding before you reserve",
    body: "Tell us your situation — resident or not, cash position, timeline — and we'll give you a straight read on how a Palm Jebel Ali purchase can be funded, and connect you with an independent mortgage advisor if you want one.",
